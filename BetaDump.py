...
beta_list = ['timing1_v1']
# beta_list = ['timing1', 'timing2', 'timing3', 'timing4', 'timing5', 'timing6', 'timing7', 
            #  'timingc_v1_eq', 'timingc_v1', 'timingc_v2_eq', 'timingc_v2', 'timingc_v3_eq', 'timingc_v3']
