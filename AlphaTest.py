...
cfg = {'startdate': '20200101',
       ...
       # 'NLRiskNeut': {'factors': 'resvol|ret20', 'group': 2},
      #  'IndNeut': {},
       'ProfitAna': {'retdays': 5, 'group': 10},
       # 'combo': False,
       # 'FactorAna': {'factors': 'size|nlsize|liq|beta|mom|ret20|resvol'},
       'GroupFactorAna': {'factors': 'resvol'}
       }
...
backtest()
# backtest.dump()
# backtest.sigbt(topN=200, weight_mode=0, benchmark='hs300')
